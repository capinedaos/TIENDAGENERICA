...
@CrossOrigin("http://localhost:upload")
@Controller
@RequestMapping
...
public class CSVController {
  ...
  // @RequestMapping(value = "http://localhost:upload", method =
  // RequestMethod.GET)
  // @GetMapping("http://localhost:upload")
  ...
  public ResponseEntity<List<Plato>> getAllTutorials() {
    try {
      List<Plato> tutorials = fileService.getAllTutorials();
